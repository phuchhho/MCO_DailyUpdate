...
using System.Web;
using MCO_DailyUpdate;
using MCO_DailyUpdate.App_Code.DAL.MCOTableAdapters;
...
public class tblMCO_FINANCEBLL
{
    ...
    {
        Adapter.tblMCO_FINANCE_Update(ID, AMOUNT, RECEIPT_NO, RECEIPT_ID, DOCUMENT, DOCUMENT_ID, DISCOUNT_AMT, REMARK, Guid.Parse(ConfigurationSettings.AppSettings["UPDATE_BY"]));
    }
